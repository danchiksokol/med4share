...
foreach ( $razdels as $key => $val ) {
    ...
    if( $site_razdel_id == $key ) {
        ...
        $html .= '<li><a href="'.$switchUrl.'" style="font-size: 16px; font-weight: bold;">Перейти в раздел '.$val['name'].' <i class="glyphicon glyphicon-chevron-up"></i></a></li>'."\n";
    }
}
...
<div class="btn-group dropdown">
   ...
   <!-- <div style="padding-top: 8px;"><strong><a href="<?/*=$switchUrl*/?>">Перейти в раздел <?/*=$switchText*/?></a></strong></div>-->
