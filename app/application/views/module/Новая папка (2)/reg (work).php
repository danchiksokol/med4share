    ...
    <section class="enter">
        <div class="enter-body">
           ...
           <p>Чтобы получить доступ к регистрации необходимо пройти опрос</p>
            ...
            <label for="question1">Вопрос 1 (правильный ответ 2)</label>
            <select name="question1">
             ...
             <label for="question2">Вопрос 2 (правильный ответ 3)</label>
          ...
          <label for="question3">Вопрос 3 (правильный ответ 2)</label>
