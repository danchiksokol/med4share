<p class="pull-right">
    <a href="/admin/expertsf/add" role="button" class="btn btn-primary">Добавить Эксперта</a>
</p>
...
<script type="text/javascript">
    $().ready(function(){
       ...
       /* */
        ...
        $('.experts_edit').on("click", function(){
            ...
            document.location.href = '/admin/expertsf/edit/'+event_id;
            return false;
        })
    ...
    function experts_view( url ) { 
        location.replace('<?=URL::base()?>expertsf/'+url); //calendar
        return false;
    }
</script>