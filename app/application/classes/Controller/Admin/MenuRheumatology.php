...
class Controller_Admin_MenuRheumatology extends Controller_Admin_Admin
{
    ...
    {
        $this->template->breadcrumb = array_merge(array('admin/menu_rheumatology' => 'Меню Ревматология'), $this->template->breadcrumb);
        parent::after();
    }

    public function action_menu_rheumatology() {

        $menu = Model::factory('MainMenu')->getMenu( 3 );

        $content = View::factory('admin/menu/main_rheumatology')->bind('menu', $menu);
