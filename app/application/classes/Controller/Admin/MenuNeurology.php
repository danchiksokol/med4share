...
class Controller_Admin_MenuNeurology extends Controller_Admin_Admin
{
    ...
    {
        $this->template->breadcrumb = array_merge(array('admin/menu_neurology' => 'Меню Неврология'), $this->template->breadcrumb);
        parent::after();
    }

    public function action_menu_neurology() {

        $menu = Model::factory('MainMenu')->getMenu( 4 );

        $content = View::factory('admin/menu/menu_neurology')->bind('menu', $menu);
