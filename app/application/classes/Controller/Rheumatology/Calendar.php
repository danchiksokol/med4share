...
class Controller_Rheumatology_Calendar extends Controller_Template_Main {
    ...
    public function action_index() {
        ...
        $this->template->breadcrumb = array( 'rheumatology' => 'Ревматология', 'Календарь событий' );
            $this->template->content = View::factory('calendar/calendar')
                ->bind('pastData', $pastData) // прошедшие
                ->bind('data', $data)
                ->set('url_event_only', '/rheumatology/calendar')
    ...
    public function action_only() {
        ...
        if($data->id > 0) {
            ...
            $this->template->breadcrumb = array( 'rheumatology' => 'Ревматология', 'rheumatology/calendar' => 'Календарь событий', $data->event_title);
