...
class Controller_Neurology_Search extends Controller_Template_Main
{
    ...
    {
        $this->template->breadcrumb = array( 'neurology' => 'Неврология', 'Поиск' );
        ...
        $this->template->content = View::factory('page/search')
            ->bind('data', $data)
            ->bind('search', $search)
            ->set('url_search_only', '/neurology/search')
            ->set( 'site_razdel', 'neurology' )
        ;
