<? /*
<link rel="stylesheet" href="<?php echo URL::site(Route::get('elfinder_media')->uri(array('file' => 'css/elfinder.min.css')), TRUE); ?>" type="text/css" media="screen" />
<link rel="stylesheet" href="<?php echo URL::site(Route::get('elfinder_media')->uri(array('file' => 'css/theme.css')), TRUE); ?>" type="text/css" media="screen" />
*/ ?>
