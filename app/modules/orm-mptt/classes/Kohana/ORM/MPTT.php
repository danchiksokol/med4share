...
class Kohana_ORM_MPTT extends ORM {
	 ...
	 * Является ли текущий узел конечного узла?
	 *
	 * @access  public
	 * @return  bool
	 */
	 ...
	 * Является ли текущий узел является потомком поставляемых узлов.
	 *
	 * @access  public
	 ...
	 * Проверяет, является ли текущий узел является прямым потомком поставляемых узлов.
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  ORM_MPTT object or primary key value of target node
	 * @return  bool
	 ...
	 * Устанавливает parent_column значение в данном столбце значения целевых показателей. Возвращает объект, цель ORM_MPTT.
	 * 
	 * @access  protected
	 ...
	 * Вставляет новый узел в качестве первого ребенка целевого узла.
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  primary key value or ORM_MPTT object of target node
	 * @return  ORM_MPTT
	 ...
	 * Вставляет новый узел в качестве последнего ребенка из целевого узла.
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  primary key value or ORM_MPTT object of target node
	 * @return  ORM_MPTT
	 ...
	 * Вставка нового узла в предыдущем братом целевого узла.
	 * 
	 * @access  public
	 * @param   ORM_MPTT|int  primary key value or ORM_MPTT object of target node
	 * @return  ORM_MPTT
	 ...
	 * Возвращает следующее доступное значение для области.
	 *
	 * @access  protected
	 * @return  int
	 **/
	 ...
	 * Возвращает прямыми потомками текущего узла.
	 * 
	 * @access  public
	 ...
	 * Возвращает листья текущего узла.
	 * 
	 * @access  public
	 * @param   bool  include the current node
	 * @param   string  direction to order the left column by
	 ...
	 * Возвращает потомков текущего узла.
	 *
	 * @access  public
	 * @param   bool      include the current node
	 * @param   string    direction to order the left column by.
